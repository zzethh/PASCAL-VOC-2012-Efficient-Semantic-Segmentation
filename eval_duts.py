...
def main():
    image_dir = "duts_dataset/DUTS-TE/DUTS-TE-Image"
    mask_dir = "duts_dataset/DUTS-TE/DUTS-TE-Mask"
    ...
    print(f"Found {len(img_names)} images in DUTS-TE.")

    all_preds = []
    all_targets = []

    with torch.no_grad():
        for img_name in tqdm(img_names, desc="Evaluating ZERO-SHOT on DUTS-TE"):
    ...
    print("\n" + "="*50)
    print(f"ZERO-SHOT DUTS-TE RESULTS")
    print("="*50)
